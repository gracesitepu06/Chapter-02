    ...
    return `
        ...
        <div class="card px-2 py-4">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-1">
                        <img src="images_cars/fi_users1.png" width="20px" alt="" srcset="">
                    </div>
                ...
                <div class="row mt-2">
                    <div class="col-1">
                        <img src="images_cars/fi_settings.png" width="20px" alt="" srcset="">
                    </div>
                    <div class="col-10 ms-lg-2">
                        ${this.transmission}
                    </div>
                ...
                <div class="row mt-2 mb-4">
                    <div class="col-1">
                        <img src="images_cars/fi_calendar.png" width="20px" alt="" srcset="">
                    </div>
                    <div class="col-10 ms-lg-2">
                        Tahun ${this.year}
                    </div>
